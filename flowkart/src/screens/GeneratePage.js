...
const GeneratePage = () => {
    ...
    const handleUpload = async (event) => {
        ...
        if (file) {
            ...
            const response = await fetch('http://localhost:5001/style_transfer', {
                method: 'POST',
                body: formData
            });
            ...
            const response = await fetch('http://localhost:5001/generate_style', {
                method: 'POST',
                headers: {
    ...
    return (
        <div style={{ textAlign: 'center', backgroundColor: 'rgb(165 151 151 / 51%)' }}>
            ...
            <form>
                ...
                <br /><br />
                <img src="/images/img1.jpg" alt="Art" style={{ maxWidth: '100%', height: 'auto' }} />
                <br />
                <h2>OR</h2>
